...
# nvcc -c gpe_imag.c -o gpe_imag.o -I/usr/local/cuda-7.0/include -I/usr/local/cuda/samples/common/inc -I./orginal/ -Xcompiler -O3 -Xcompiler -march=native -Xcompiler -msse4 -Xcompiler -m64 -Xcompiler -fopenmp -DNX=$NX -DNY=$NY -DNZ=$NZ
...
# nvcc -c gpe_real.c -o gpe_real.o -I/usr/local/cuda-7.0/include -I/usr/local/cuda/samples/common/inc -I./orginal/ -Xcompiler -O3 -Xcompiler -march=native -Xcompiler -msse4 -Xcompiler -m64 -Xcompiler -fopenmp -DNX=$NX -DNY=$NY -DNZ=$NZ
...
# nvcc -c gpe_imag.c -o gpe_imag.o -I/usr/local/cuda-7.0/include -I/usr/local/cuda/samples/common/inc -I./dev/ -Xcompiler -O3 -Xcompiler -march=native -Xcompiler -msse4 -Xcompiler -m64 -Xcompiler -fopenmp -DNX=$NX -DNY=$NY -DNZ=$NZ -DDEV
...
# nvcc -c gpe_real.c -o gpe_real.o -I/usr/local/cuda-7.0/include -I/usr/local/cuda/samples/common/inc -I./dev/ -Xcompiler -O3 -Xcompiler -march=native -Xcompiler -msse4 -Xcompiler -m64 -Xcompiler -fopenmp -DNX=$NX -DNY=$NY -DNZ=$NZ -DDEV
